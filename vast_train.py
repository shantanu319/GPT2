...
def main():
    ...
    sp.add_argument("--bpe-train-docs", type=int, default=100000)
    ...
    sp = sub.add_parser("train", help="pretrain on the instance (~101M defaults)")
    sp.add_argument("--d-model", type=int, default=512)
    sp.add_argument("--n-layers", type=int, default=30)
    sp.add_argument("--heads", type=int, default=8)
    sp.add_argument("--kv-heads", type=int, default=2)
    ...
    sp.add_argument("--beta", type=float, default=0.5)
    sp.add_argument("--lr", type=float, default=1e-6)
    sp.add_argument("--muon-lr", type=float, default=0.0)
    sp.add_argument("--warmup-steps", type=int, default=100)
    sp.add_argument("--save-every", type=int, default=1000)
    sp.add_argument("--val-every", type=int, default=500)
    ...
    sp = sub.add_parser("pipeline", help="prepare -> pretrain -> sft -> dpo, detached + resumable (~101M defaults)")
    sp.add_argument("--dir-name", default="vast_run")
    ...
    sp.add_argument("--dpo-epochs", type=int, default=2)
    sp.add_argument("--dpo-batchsize", type=int, default=8)
    sp.add_argument("--dpo-beta", type=float, default=0.5)
    sp.add_argument("--dpo-lr", type=float, default=1e-6)
    sp.add_argument("--dpo-muon-lr", type=float, default=0.0)
